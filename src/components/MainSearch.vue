<template>
    <div class="wrapper">
        <input type="text" placeholder="Find your island today!" class="search" />
...
.wrapper {
    ...
    .search {
        @apply px-3 py-4 placeholder-slate-400 text-slate-700 rounded-md border-0 outline-none focus:ring focus:ring-purple-500;
    }
